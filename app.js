define(["san","san-types"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_268__) { return webpackJsonp([1],{
...
var _showcase = __webpack_require__(254);
...
function start() {
  (0, _showcase.start)(); // eslint-disable-line
}
...
var _Aside = __webpack_require__(263);

var _Aside2 = _interopRequireDefault(_Aside);

var _AppExplorer = __webpack_require__(265);

var _AppExplorer2 = _interopRequireDefault(_AppExplorer);

var _config3 = __webpack_require__(46);
...
function activateI18n() {
    // 设置 i18n 相关的配置
    _config2.default.url = 'https://console-i18n.bj.bcebos.com/console.%s';
    _config2.default.sourceType = 'amd';
    var locale = /locale=([a-zA-Z\-]+)/g.exec(location.search);
    var toSet = (locale || [])[1];
    return _infI18n2.default.activate(toSet || _infI18n2.default.getLanguage());
}
...
var App = (0, _san.defineComponent)({ // eslint-disable-line
    ...
    onItemSelected: function onItemSelected(item) {
        ...
        var demosModulePrefix = '\x69nf-ui/x/demos/';
        var demosCodePrefix = '\x69nf-ui/x/demos/';
        ...
        var ext = typeof G_SOURCE_EXT === 'string' ? G_SOURCE_EXT : '.es6';
        ...
        var sourceUrl = window.require.toUrl(sourceCodeId).replace(/\?.*/, '') + ext;
...
var _Section = __webpack_require__(266);

var _Section2 = _interopRequireDefault(_Section);

var _DataTypeExplorer = __webpack_require__(267);
...
var _sanTypes = __webpack_require__(268);
...
exports.default = (0, _san.defineComponent)({
    ...
    inited: function inited() {
        ...
        this.watch('code', function (code) {
            ...
            var ext = typeof G_SOURCE_EXT === 'string' ? G_SOURCE_EXT : '.es6';
            var moduleId = (typeof G_PREFIX === 'undefined' ? 'undefined' : _typeof(G_PREFIX)) === 'object' ? '' + G_PREFIX.componentsCode + compName : 'inf-ui/x/components/' + compName;
            var sourceUrl = window.require.toUrl(moduleId).replace(/\?.*/, '') + ext;
            fetch(sourceUrl).then(function (response) {
