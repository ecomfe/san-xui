define(["san","san-types"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_312__) { return webpackJsonp([2],{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_less__ = __webpack_require__(234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__showcase__ = __webpack_require__(252);
/**
 * @file app.es6
 * @author leeight
 */
...
function start() {
    Object(__WEBPACK_IMPORTED_MODULE_1__showcase__["a" /* start */])(); // eslint-disable-line
}
...
module.exports = __webpack_require__.p + "assets/images/86298219ae96c693097ad73d0e59ac51.gif";
...
module.exports = __webpack_require__.p + "assets/images/a7e86fc5be14784777bd28a8082aa605.png";
...
module.exports = __webpack_require__.p + "assets/images/5862280209539c235d15e5f30e9e06c9.png";
...
module.exports = __webpack_require__.p + "assets/images/a0228a25830af168b8c465ce52a58d7b.png";
...
module.exports = __webpack_require__.p + "assets/images/84c3d05dbb43525dac2a16c440ed069a.png";
...
module.exports = __webpack_require__.p + "assets/images/2648755ac0715d5883e8e9df99aa4ce0.png";
...
module.exports = __webpack_require__.p + "assets/images/3a11feaa286bbec3de90010ab4951b33.png";
...
module.exports = __webpack_require__.p + "assets/images/89f3311d7e1e9d631e251fc38a581ddc.png";
...
module.exports = __webpack_require__.p + "assets/images/b784b8eb910c1077747733815221cedc.png";
...
module.exports = __webpack_require__.p + "assets/images/844d9fc5efb17959fe9b11931491bce1.png";
...
module.exports = __webpack_require__.p + "assets/images/596be6c2fa8e2335db823d1df6f315ce.gif";
...
module.exports = __webpack_require__.p + "assets/images/c2d4f843d5ce40c4a00b6285e8205bb1.svg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_inf_i18n__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_inf_i18n_config__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_inf_ui_x_components_Icon__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Aside__ = __webpack_require__(261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__AppExplorer__ = __webpack_require__(309);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__demos_config__ = __webpack_require__(68);
/**
 * @file showcase.es6
 * @author leeight
 */
...
function activateI18n() {
    // 设置 i18n 相关的配置
    __WEBPACK_IMPORTED_MODULE_5_inf_i18n_config__["a" /* default */].url = 'https://console-i18n.bj.bcebos.com/console.%s';
    __WEBPACK_IMPORTED_MODULE_5_inf_i18n_config__["a" /* default */].sourceType = 'amd';
    let locale = /locale=([a-zA-Z\-]+)/g.exec(location.search);
    let toSet = (locale || [])[1];
    return __WEBPACK_IMPORTED_MODULE_4_inf_i18n__["a" /* default */].activate(toSet || __WEBPACK_IMPORTED_MODULE_4_inf_i18n__["a" /* default */].getLanguage());
}
...
if (typeof __WEBPACK_IMPORTED_MODULE_2_promise___default.a.onReject === 'function'
    && typeof __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.noop === 'function') {
    __WEBPACK_IMPORTED_MODULE_2_promise___default.a.onReject(__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.noop);   // eslint-disable-line
}

const App = Object(__WEBPACK_IMPORTED_MODULE_3_san__["defineComponent"])({   // eslint-disable-line
    template,
    components: {
        'ui-icon': __WEBPACK_IMPORTED_MODULE_6_inf_ui_x_components_Icon__["a" /* default */],
        'ui-aside': __WEBPACK_IMPORTED_MODULE_7__Aside__["a" /* default */],
        'ui-explorer': __WEBPACK_IMPORTED_MODULE_8__AppExplorer__["a" /* default */]
    },
    initData() {
        return {
            blocks: __WEBPACK_IMPORTED_MODULE_9__demos_config__["a" /* blocks */],
            aside: {
                expand: false
            },
            explorer: {
    ...
    inited() {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).on('hashchange', hashchangeHandler);
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).on('click', clickHandler);
        hashchangeHandler();
    },
    disposed() {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).off('hashchange');
    },
    onToggleAside(e) {
        e.stopPropagation();
...
"use strict";
/**
 * @file i18n相关的配置，直接用，直接改
 * @author Leo Wang(leowang721@gmail.com)
 */

/* harmony default export */ __webpack_exports__["a"] = ({
    defaultLanguage: 'zh-cn', // 默认支持语言，即开发使用的语言，使用此语言，不需要加载数据包，语言无对应项也会降级为此语言话术
    supportedLanguage: ['zh-cn', 'en-us'], // 白名单模式

    // 语言降级的默认匹配，例如 en-ca 白名单未命中，进行降级为 en，进而默认为 en-us
    downgradeDefault: {
        en: 'en-us',
        zh: 'zh-cn'
    },
    ...
    /**
     * 数据源类型，这也代表了请求的方式
     * json 表示是 .json 类型的文件，将使用 xhr 的方式加载，不支持跨域
     * amd 表示是 amd 模块的js文件，将使用 global require 的方式加载，此类支持跨域
     * data 表示直接使用的内存数据（之前加载过或处理出来的） 不执行请求
     * 	    如果用 data，必须要去做 setDatasource 的处理，否则不会生效
     *
     * @type {string}
     */
    sourceType: 'json',
    url: '' // 请求的url，里面使用 %s 占位代表当前的语言，例如 http://some.cdn/i18n?lang=%s
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_san__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_san___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_san__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inf_ui_x_components_SearchBox__ = __webpack_require__(30);
/**
 * @file aside.es6
 * @author leeight
 */
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_1_san__["defineComponent"])({
    template,
    components: {
        'ui-searchbox': __WEBPACK_IMPORTED_MODULE_2_inf_ui_x_components_SearchBox__["a" /* default */]
    },
    initData() {
        return {
            activedItem: null,
    ...
    computed: {
        filteredBlocks() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(blocks, block => {
                const items = [];
                __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(block.items, item => {
...
module.exports = __webpack_require__.p + "assets/images/c6bf940f070b2c4d2a5636074832f91b.gif";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_inf_ui_x_components_SyntaxHighlighter__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__demos_Section__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__demos_DataTypeExplorer__ = __webpack_require__(311);
/**
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0_san__["defineComponent"])({
    template,
    components: {
        'ui-loading': __WEBPACK_IMPORTED_MODULE_1_inf_ui_x_components_Loading__["a" /* default */],
        'ui-hljs': __WEBPACK_IMPORTED_MODULE_2_inf_ui_x_components_SyntaxHighlighter__["a" /* default */],
        'x-datatype-explorer': __WEBPACK_IMPORTED_MODULE_4__demos_DataTypeExplorer__["a" /* default */],
        'x-section': __WEBPACK_IMPORTED_MODULE_3__demos_Section__["a" /* default */]
    },
    initData() {
        return {
            comp: null,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inf_ui_sanx__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_inf_ui_x_components_Icon__ = __webpack_require__(24);
/**
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_0_inf_ui_sanx__["b" /* defineComponent */])({
    ...
    components: {
        'ui-icon': __WEBPACK_IMPORTED_MODULE_1_inf_ui_x_components_Icon__["a" /* default */]
    },
    computed: {
        viewportStyle() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_san_types__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_san_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_san_types__);
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_2_inf_ui_sanx__["b" /* defineComponent */])({
    template,
    components: {
        'ui-icon': __WEBPACK_IMPORTED_MODULE_3_inf_ui_x_components_Icon__["a" /* default */]
    },
    initData() {
        return {
            typeDefs: []
    ...
    inited() {
        this.watch('code', code => {
            ...
            const pattern = new RegExp('\'' + __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.escapeRegExp(key) + '\'\\s*:\\s*([\\.\\/\\w]+)', 'gm');
            ...
            fetch(sourceUrl)
                ...
                .then(code => {
                    const typeDefs = Object(__WEBPACK_IMPORTED_MODULE_1_san_types__["parse"])(code) || [];
                    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(typeDefs, T => {
                        T.name = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.kebabCase(T.name);
                    });
                    typeDefs.sort((a, b) => {
                        if (hasF(a) && !hasF(b)) {
                            return -1;
...
module.exports = __webpack_require__.p + "assets/images/668e73d99eb967dcd568739a21bb113f.png";
