...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__voice__ = __webpack_require__(390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__voice___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__voice__);
/**
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_0_inf_ui_sanx__["b" /* defineComponent */])({
    ...
    attached() {
        if (!__WEBPACK_IMPORTED_MODULE_4__voice___default.a.support()) {
            return;
        }
        __WEBPACK_IMPORTED_MODULE_4__voice___default.a.addStyle();
    },

    start() {
        __WEBPACK_IMPORTED_MODULE_4__voice___default.a.init({url: 'https://sp3.baidu.com/6qUDsjip0QIZ8tyhnq/echo.fcgi'})
            .done(recorder => {
                recorder.openUI();
                recorder.onfinish(t => {
