...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__voice__ = __webpack_require__(486);
/**
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_0_san__["defineComponent"])({
    ...
    attached() {
        if (!__WEBPACK_IMPORTED_MODULE_3__voice__["a" /* default */].support()) {
            return;
        }
        __WEBPACK_IMPORTED_MODULE_3__voice__["a" /* default */].addStyle();
    },

    start() {
        __WEBPACK_IMPORTED_MODULE_3__voice__["a" /* default */].init({url: 'https://sp3.baidu.com/6qUDsjip0QIZ8tyhnq/echo.fcgi'})
            .done(recorder => {
                recorder.openUI();
                recorder.onfinish(t => {
...
function addMask(e) {
    if (!m) {
        var e = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend({
            top: 0,
            "z-index": 999
        }, e);
        g || (g = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<div id='_voice_mask' data-for='result'/>")), g.css({
            opacity: .3,
            position: "absolute",
            background: "#000",
            "z-index": e["z-index"],
...
var Recorder = function(e, t) {
    ...
    function n(e, r) {
        !r && w.length > 4 || e.getSendBuffer(function(n) {
            if (n) {
                y = e.glb = n.json.glb;
                var i = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
                    url: t.url,
                    cache: !1,
                ...
                w.push(i), i.always(function(t) {
                    ...
                    return w = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.grep(w, function(e) {
                        return i !== e;
    ...
    var i = this.source = a.createMediaStreamSource(e), c = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend({
        timeout: 5e3
    }, t);
    c.eq;
    ...
    this.node.onaudioprocess = function(e) {
        if (m) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(i, function(e, t) {
                s += Math.abs(t - a);
    ...
    var v = {}, b = this;
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each([ "audioprocess", "stop", "start", "finish", "stop", "result", "fail", "noUserMedia", "volumnLow" ], function(e, t) {
        v[t] = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.Callbacks(), b["on" + t] = function(e) {
            v[t].add(e);
        };
        ...
        m && (e ? (__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(w, function(e, t) {
            t.abort();
...
var g, p, m = !1, A = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("body"), v = function() {
    var e, n, i, a, s, o, f;
    return function(u) {
        function c() {
        ...
        e || (e = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("<div id='voice' data-for='result'><div class='close'>x</div><div class='result'>" + "<span class='result-word'></span><span class='tip'></span></div><div class='voic" + "e_inner'><img class='btn' src='https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/w" + "ww/cache/static/protocol/https/voice/imgs/start_btn_e61e030.png'><div class='box" + "'><div class='box_inner'></div></div><div class='round2'></div><div class='round" + "1'></div><div class='round3'></div></div></div>"), 
        n = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".btn", e), i = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".result-word", e), f = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".tip", e), a = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".box_inner", e), 
        s = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".round3", e), o = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".round2,.round1", e)), f.mousedown(function() {
            Recorder.log({
                q: "setVolumn"
            });
        }), __WEBPACK_IMPORTED_MODULE_0_jquery___default()(".close", e).click(function() {
...
Recorder.showTip = function() {
    ...
    e = bds && bds.se && bds.se.upn && bds.se.upn.cookieset && bds.se.upn.cookieset[0] && 2 == bds.se.upn.cookieset[0].v ? __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend(e, {
        top: "0",
        right: "40px",
        width: "205px"
    }) : __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.extend(e, {
        top: "25%",
        right: "inherit",
        width: "100%"
    }), p || (p = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div><img src="https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/' + 'protocol/https/voice/imgs/allow_d7a970f.png" usemap="#voiceTipMap"/><map name="v' + 'oiceTipMap"><area shape="circle" coords="13,55,8"></map></div>').css(e), 
...
Recorder.init = function(t) {
    var n = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.Deferred();
    if (i) {
        ...
        i = r, x || (x = !0, __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).on("blur", function() {
            b = setTimeout(function() {
                i && (i.stop && i.stop(), i = null);
            }, 1e4);
        }), __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).on("focus", function() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<span class="ipt_rec"></span>').prependTo(__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#kw").parent());
    ...
    addStyleEle(t, "forResult"), window.bds && bds.comm && bds.comm.newindex) {
        var o = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#kw").parent().width() - 30, f = addStyleEle(".ipt_rec{left:" + o + "px;top:3px}");
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).one("index_off", function() {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(f).remove();
        });
    }
